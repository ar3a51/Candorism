...
gulp.task('sass', function() {
	...
	gulp.src('src/Bootstrap/scss/*.scss')
		...
		.pipe(gulp.dest('./wwwroot/Bootstrap/dist/css'))
...
gulp.task('js', function () {
	...
	gulp.src('src/Bootstrap/dist/js/*.js')
		...
		.pipe(gulp.dest('./wwwroot/Bootstrap/dist/js'))
...
gulp.task('images', function(){
	...
	gulp.src('src/screenshots/*')
		...
		.pipe(gulp.dest('wwwroot/screenshots'));
});
...
gulp.task('svg-min', function () {
	gulp.src('src/svg-icons/*.svg')
		...
		.pipe(gulp.dest('wwwroot/svg-icons'));
...
gulp.task('copy-files', function() {
	...
	gulp.src('src/mp3/*.*')
        .pipe(gulp.dest('wwwroot/mp3'));

	gulp.src('src/videos/*.*')
        .pipe(gulp.dest('wwwroot/videos'));

	gulp.src('src/svg-icons/sprites/*.svg')
        .pipe(gulp.dest('wwwroot/svg-icons/sprites'));
...
gulp.task('build', ['clean-app'], function(done) {
	...
	runSequence('sass', 'js', 'svg-min', 'copy-files', 'images', 'compress', done);
});
